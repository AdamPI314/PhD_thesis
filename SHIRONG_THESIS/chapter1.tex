...
networks which we term ‘the sum over histories representation’, or SOHR for short.\cite{ch1_IRPC_15_kramer2014following,ch1_IRPC_16_bai2014sum,ch1_IRPC_17_bai2015sum,ch1_IRPC_18_bai2017simulating} This method replaces the usual concentration based kinetics with a representation
...
motivation from Feynman’s ‘sum over histories’ approach to quantum mechanics.\cite{ch1_IRPC_23_feynman1965quantum}
