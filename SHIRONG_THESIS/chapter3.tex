...
chemical kinetic networks.\cite{ch1_IRPC_1_laidler1987chemical,ch3_2_saltelli2000,ch1_IRPC_55_turanyi2008sensitivity} In chemical kinetic sensitivity analysis the response of a target observable, such as a species
...
the function representation of the target.\cite{ch1_IRPC_56_najm2009uncertainty} Although the utility
...
interpret kinetic sensitivity.\cite{ch1_IRPC_15_kramer2014following,ch1_IRPC_16_ch3_6_ch4_8_bai2014sum} 
\newline
\paragraph{}
...
\begin{figure}[htbp]
	\caption[Correlation between pathways]{Correlation between pathways (a1, b1) in the upper panel and (a1, c1) in the lower panel for the H$_2$O target evaluated at $t=0.8\tau_{ign}$. The correlation has been decomposed into the contributions
